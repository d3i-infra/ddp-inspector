...
[
    ...
    [pd.Timestamp('2020-12-02 14:28:23.382748'), pd.Timestamp('2020-12-01 14:28:23.382748')]),
    ...
    (convert_timestamp(["01-02-2022", "01-10-2022"]),
    [pd.Timestamp("2022-02-01 00:00:00"), pd.Timestamp("2022-10-01 00:00:00")]),
    (["12-31-2022", "02-01-2022"],
    [pd.Timestamp("2022-12-31 00:00:00"), pd.Timestamp("2022-01-02 00:00:00")]),
    (["20220102", "20220201"],
    [pd.Timestamp("2022-01-02 00:00:00"), pd.Timestamp("2022-02-01 00:00:00")]),

    # Timestamps that wont be processed as expected
    (["02-01-2022", "12-31-2022"],
    [pd.Timestamp("2022-01-02 00:00:00"), pd.Timestamp("2022-12-13 00:00:00")]),
